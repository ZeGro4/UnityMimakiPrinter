	...
	public void ChangeInstruction(int num)
	{
		...
		switch (num) { 
            ...
            case 6:
                ...
                break;
            case 7:
                textInstruction.text = "Нажмите на файл изображения текстуры для выбора её для печати, после чего нажмите на выделенную кнопку 'Open'. В появившемся окне нажмите на выделенную кнопку для отправки данных печати на плоттер. Нажмите клавишу Т для перехода к панели управления плоттера. На панели управления нажмите кнопку Remote для принятия данных и печати. Переходите к следующему этапу.";
                break;
            case 8:
